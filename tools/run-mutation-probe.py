...
MUTANTS = [
    ...
    ("cpp: the divisibility guard disappears",
     "src/domain/SequencerEngine.cpp",
    ...
    ("ts: the sub-onset slot is one tick too long",
     "sim/src/domain/SequencerEngine.ts",
     "    c.slotTicks = c.stepTicks / triggers;",
     "    c.slotTicks = c.stepTicks / triggers + 1;", "ts-ratchet"),
