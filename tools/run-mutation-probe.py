...
MUTANTS = [
    ...
    ("cpp: the modulation buffer starts with a length of sixteen",
     "include/flexseq/SequencerEngine.h",
     "        : pattern(), length{},",
     "        : pattern(), length{16, 16, 16, 16, 16, 16},", "cpp-engine"),
