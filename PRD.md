...
- the glyph of **PATTERNS is a small grid of steps**, two rows of three dots in 7×5 px. ⚠️ **A DOT IS ONE PIXEL, and it was two pixels high until 2026-09-09.** Six dots of 1×2 make three broken vertical bars. They do not read as a grid. The owner read that on the render of the pixel mirror. The two rows of dots sit on the rows 58 and 62. ⚠️ **This line said 58 and 61 for one commit**, before the render was read: on 58 and 61 the glyph floats 1 px above the bottom row. On 58 and 62 it shares the bottom row with the digits, and it fills the 7×5 box this line declares;
