...
- the glyph of **PATTERNS is a small grid of steps**, two rows of three dots in 7×5 px. ⚠️ **A DOT IS ONE PIXEL, and it was two pixels high until 2026-09-09.** Six dots of 1×2 make three broken vertical bars. They do not read as a grid. The owner read that on the render of the pixel mirror. The two rows of dots sit on the rows 58 and 61;
