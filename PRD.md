...
**Mesuré et écarté, pour que personne ne le retente** : le constructeur du moteur ne vaut que **88 o** sur les 1646 o de code de constructeurs globaux ; **tous** les leviers d'inlining rendent zéro ou pire sous `-Os` avec LTO. Ce qui reste est soit la dépendance épinglée — ISR d'uClock 974 o, Wire 574 o, u8g2 \~1500 o, et **586 o d'allocateur** qu'uClock impose en allouant quatre octets à l'init — soit les deux renderers dont l'interface a besoin.
⚠️ **Conséquence assumée par le propriétaire** : la Flash se mesure à **chaque** lot restant, pas seulement à la fin. Le repli est une ligne de code et la décision se reprend alors sur le chiffre réel : `logisoso22_tr` rend 420 o (même famille, 22 px au lieu de 26), `profont22_tr` rend 984 o (autre famille, l'allure change). Le garde-fou à 90 % n'est **pas** levé : le lever ne créerait pas de place, il retirerait un avertissement. Levier non vérifié : `docs/open-risks.md` ligne 24.
...
**⚠️ CHIFFRES COURANTS, mesurés le 2026-08-30 après le lot B4b.7.** Tout ce qui suit est antérieur et conservé comme historique.
**RAM 1338 / 2048 (65,3 %)**, 710 o libres · **Flash 27446 / 30720 (89,3 %)** · **pic de pile 205 o**, marge 505 o, couvert 1,2× par la réserve de 256 · tests C++ 458, adaptateur 5, image EEPROM 14, TypeScript 451, typage propre, caractérisation libGravity conforme · **mutation 230/230** · sondes : gestes 103, dérive 222/222, frontière EEPROM 588/588, rendu identique à 863 pixels d'encre · 7 environnements AVR compilent.
