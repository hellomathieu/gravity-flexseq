...
checked clean, both give PASS with 106 green criteria. Two orphan `simavr`
processes from earlier runs were on the host on the day of the red, and that is
the only candidate anybody named. The rule: a probe that drives a simulator
