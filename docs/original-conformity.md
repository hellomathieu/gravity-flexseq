...
| External clock start | starts by itself on the first external pulse (`Gravity.ino:321-322, 338-339`) | same, since 2026-08-25 | **was an omission**, fixed by T4. Without it the external source would have been unstartable, since PLAY is now inert there |
