...
|---|---|---|---|
| Tab count | 7: clock glyph `w` then digits 1 to 6 (`UI.ino:239-260`) | **8**: clock, 6 channels, global config, in slots of **12 px** as in the original | **assumed divergence** — the owner moved the settings page into the bar, 2026-08-23. ⚠️ **This row said 9 from 2026-09-09 to 2026-09-14**, the `PATTERNS` tab having lived between the last channel and `CONF`. Its removal — PRD §5.0, third amendment of 2026-09-14 — brings the bar back to one tab more than the original, and that one tab is `CONF`. ⚠️ **It said 8 before 2026-09-09** for a different reason, the settings tab being the eighth |
...
| Glyph of the PATTERNS tab | — the original has no such tab | **REMOVED on 2026-09-14** — it was a grid of steps, two rows of three dots of one pixel, 7 px by 5 px | **no divergence any more** — the tab is removed, PRD §5.0, third amendment of 2026-09-14. The row stays because the `CONF` glyph takes its 7 px by 5 px from it |
